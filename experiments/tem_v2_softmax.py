...
from ehc_sn.models.tem_v2 import ModelSettings_V2
from ehc_sn.runtimes.training.tem_v2 import ModelConfig_TEM_V2, RuntimeConfig, TrainingModel
...
CONFIGURATION_PATH = os.environ.get("TEM_V2_CONFIGURATION_PATH", "config/tem-dungeons.v2.toml")
...
class RunArguments(BaseSettings, extra="forbid", cli_parse_args=True):
    ...
    model: ModelSettings_V2 = Field(
        ...,
        description="TEM v2 model architecture settings.",
    )
