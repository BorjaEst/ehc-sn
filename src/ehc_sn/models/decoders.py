...
the encoders and support both standard backpropagation (BP) and Direct Random Target
Projection (DRTP) training methods.
...
3. Conv2D: Transpose convolutional decoder for spatial data reconstruction
4. DRTPConv2D: DRTP-enabled transpose convolutional decoder
