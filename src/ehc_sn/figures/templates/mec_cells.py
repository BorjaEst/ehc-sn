...
from ehc_sn.figures.selectors.mec import MECCellFigureData, select_mec_cell
from ehc_sn.figures.utils.axes import mosaic_axes
from ehc_sn.traces.trace_tree import TraceTree


def plot(trace: TraceTree, ctx: FigureContext) -> Figure:
    return MECCellsFigure(select_mec_cell(trace, ctx), ctx).plot()


class MECCellsFigure(BaseFigureTemplate):
    ...
    def __init__(self, data: MECCellFigureData, ctx: FigureContext) -> None:
    ...
    def spatial_maps(self, ax: Axes) -> None:
        ...
        ax.set_title(f"MEC f{self.data.freq_idx} rate map")
    ...
    def spatial_matrices(self, ax: Axes) -> None:
        ...
        ax.set_title(f"MEC f{self.data.freq_idx} spatial autocorr")
