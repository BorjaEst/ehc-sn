...
def colorbar(
    *, group: str, label: str | None = None, tick_labelsize: float | None = None,
    ...
    def decorator(fn: Callable[..., Any]) -> Callable[..., Any]:
        setattr(fn, "_tem_colorbar", {"group": group, "label": label, "tick_labelsize": tick_labelsize})
        return fn
...
def panel(
    *, slots: Sequence[str] | None = None, primary: str | None = None, order: int | None = None,
    ...
    def decorator(fn: Callable[..., Any]) -> Callable[..., Any]:
        ...
        setattr(fn, "_tem_panel", {"slots": tuple(owned_slots), "primary": primary_slot, "order": order})
        return fn
