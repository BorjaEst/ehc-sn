"""Canonical maze semantic (SEM) vocabulary.

Defines the canonical integer IDs used to encode maze grid cells as a
model-agnostic semantic enum. This vocabulary is shared by the data pipeline
(datasets, transforms, gymnasium environments) and is the stable contract
for all consumers.
...
Note:
    ...
    vocabulary. It is an HRM-private supervision annotation defined in
    ``ehc_sn.models.hrm_v1``.
"""
