...
_SEQMAZE_HRM_V2_PROVIDER_REF = (
    "ehp_sn.tasks.mazehard.providers.MazeHardReplayProvider"
)

_SEQMAZE_HRM_V2_REGIME_ID = "seqmaze_diagnostic"
_SEQMAZE_HRM_V2_REGIME_KIND = "diagnostic"


def _resolve_seqmaze_hrm_v2_assembly(
    build_request: EvaluationBuildRequest,
) -> tuple[SeqMazeHRMV2ComponentConfigs, Path]:
...
def build_seqmaze_hrm_v2_evaluation_experiment(
    ...
    """
    components, model_config_path = _resolve_seqmaze_hrm_v2_assembly(
        build_request
    )
    ...
    deliberation = SeqMazeDeliberationConfig()
    ...
    provider_spec = ProviderSpec(
        ref=_SEQMAZE_HRM_V2_PROVIDER_REF,
        settings=settings,
    ...
    return EvaluationExperiment(
        ...
        regime_id=_SEQMAZE_HRM_V2_REGIME_ID,
        regime_kind=_SEQMAZE_HRM_V2_REGIME_KIND,
