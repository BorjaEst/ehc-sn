"""Training experiment assembly for Routebind × HRM-v1."""
...
from .config import RoutebindHRMV1TrainingExperimentConfig
from .model import build_routebind_hrm_v1_model


def build_routebind_hrm_v1_training_experiment(
    config: RoutebindHRMV1TrainingExperimentConfig,
) -> TrainingExperiment:
    """Build a complete training experiment for Routebind × HRM-v1."""
    ...
    module = build_routebind_hrm_v1_model(
        config.model,
...
__all__ = ["build_routebind_hrm_v1_training_experiment"]
