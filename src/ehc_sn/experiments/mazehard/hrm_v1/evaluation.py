...
_MAZEHARD_HRM_V1_PROVIDER_REF = (
    "ehp_sn.tasks.mazehard.providers.MazeHardReplayProvider"
)
"""Provider import path for MazeHard.  Recipe-owned."""

_MAZEHARD_HRM_V1_REGIME_ID = "mazehard_diagnostic"
_MAZEHARD_HRM_V1_REGIME_KIND = "diagnostic"


def _resolve_mazehard_hrm_v1_assembly(
    build_request: EvaluationBuildRequest,
) -> tuple[MazeHardHRMV1ComponentConfigs, Path]:
    ...
    components = MazeHardHRMV1ComponentConfigs(
        ...
        task_evaluator=MazeHardTaskEvaluatorConfig(),
...
def build_mazehard_hrm_v1_evaluation_experiment(
    ...
    """
    components, model_config_path = _resolve_mazehard_hrm_v1_assembly(
        build_request
    )
    ...
    provider_spec = ProviderSpec(
        ref=_MAZEHARD_HRM_V1_PROVIDER_REF,
        settings=settings,
    ...
    return EvaluationExperiment(
        ...
        regime_id=_MAZEHARD_HRM_V1_REGIME_ID,
        regime_kind=_MAZEHARD_HRM_V1_REGIME_KIND,
