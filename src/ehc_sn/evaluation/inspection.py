...
Usage::
    ...
    from ehc_sn.evaluation.inspection import inspect_evaluation_artifact
...
Boundary rules:
    ...
    - May import ``TraceTree`` from ``traces`` and ``load_artifact_run_cases``
      from ``evaluation.artifacts`` (both are artifact-level operations).
"""
...
from ehc_sn.evaluation.contracts import EvaluationIdentity
...
# =============================================================================
# Constants (mirrored from evaluation.artifacts — avoids circular import risk)
# =============================================================================
...
def _build_gallery(
    *,
    ...
    # Resolve the evaluation artifact digest for provenance.
    source_digest = ""
    try:
    ...
    gallery_manifest: dict[str, object] = {
        "schema": "ehp_sn.evaluation.inspection.v1",
