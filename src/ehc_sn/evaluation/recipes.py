...
Usage::
    ...
    from ehc_sn.evaluation.recipes import resolve_recipe
...
from ehc_sn.evaluation.recipe_catalogue import load_recipe_config
from ehc_sn.evaluation.recipe_schema import (
