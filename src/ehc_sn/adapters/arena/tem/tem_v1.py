...
class ArenaOutputsDecoderV1(nn.Module):
    ...
    def forward(self, model_output: TEMOutputV1) -> ArenaTEMBridgeOutput:
...
class ArenaTEMV1BridgeAdapter(nn.Module):
    ...
    def __init__(self, model: TEMModelV1, config: ArenaTEMAdapterSettings) -> None:
        super().__init__()
        self._config = config
        self.model = model
...
# =============================================================================
def _build_encoder_v1(model: TEMModelV1, config: ArenaTEMAdapterSettings) -> ArenaInputsEncoderV1:
...
def _build_decoder_v1(model: TEMModelV1, config: ArenaTEMAdapterSettings) -> ArenaOutputsDecoderV1:
