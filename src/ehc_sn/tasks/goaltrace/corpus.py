"""Goaltrace corpus reader — load persisted arrays from a versioned root.
...
_GOALTRACE_CHANNELS: tuple[str, ...] = GOALTRACE_CORPUS_CHANNELS
...
def load_sample(
    ...
    split: str,
    index: int,
    channels: tuple[str, ...] = _GOALTRACE_CHANNELS,
) -> dict[str, np.ndarray]:
    ...
    Args:
        ...
        channels: Channel names to load (default: all goaltrace channels).
