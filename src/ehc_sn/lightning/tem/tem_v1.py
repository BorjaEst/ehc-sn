...
class TrainingModel(L.LightningModule):
    ...
    def execute_evaluation_batch(
        ...
        Arena world/context supplements are applied to the trace before returning so
        that the artifact is fully prepared for visualization.
...
def _maybe_apply_arena_supplements(
    ...
    Args:
        ...
        source_context: Typed provider context; supplements applied only when Arena-typed.

    Returns:
        Tuple of applied supplement ids (``("arena",)`` or empty).
    """
