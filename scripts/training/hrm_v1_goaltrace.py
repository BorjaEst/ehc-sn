"""Training entrypoint for HRM v1 Goaltrace (ACT-supervised)."""
...
from ehc_sn.experiments.goaltrace.hrm_v1.training import (
...
DEFAULT_CONFIG = "config/training/hrm-v1-goaltrace-vram8gib.toml"
...
class CliSettings(BaseSettings):
    """CLI entry point for HRM v1 Goaltrace training.
    ...
    experiment: GoaltraceHRMV1TrainingExperimentConfig = Field(
        ...,
        description="Experiment configuration. Defaults are loaded from a "
        "TOML file, but can be overridden via CLI using dotted paths, e.g. "
...
if __name__ == "__main__":
    ...
    experiment = build_goaltrace_hrm_v1_training_experiment(settings.experiment)
