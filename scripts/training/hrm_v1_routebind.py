"""Training entrypoint for HRM v1 Routebind (ACT-supervised)."""
...
from ehc_sn.experiments.routebind.hrm_v1.training import (
...
DEFAULT_CONFIG = "config/training/hrm-v1-routebind-vram8gib.toml"


# =============================================================================
class CliSettings(BaseSettings):
    """CLI entry point for HRM v1 Routebind training.
    ...
    experiment: RoutebindHRMV1TrainingExperimentConfig = Field(
        ...,
...
if __name__ == "__main__":
    ...
    experiment = build_routebind_hrm_v1_training_experiment(settings.experiment)
