...
if __name__ == "__main__":
    ...
    trainer = Trainer(
        ...
        strategy=resolve_trainer_strategy(settings.trainer_strategy, world_size),  # fmt: skip
    ...
    trainer.fit(
        ...
        datamodule=Datamodule(settings.datamodule, transform=coerce_maze_hard_batch),  # fmt: skip
