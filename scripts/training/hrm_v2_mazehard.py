...
from ehc_sn.experiments.mazehard.hrm_v2.training import (
...
DEFAULT_CONFIG = "config/training/hrm-v2-mazehard-vram8gib.toml"
...
class CliSettings(BaseSettings):
    """CLI entry point for HRM v2 MazeHard training.
    ...
    experiment: MazeHardHRMV2TrainingExperimentConfig = Field(
        ...,
...
if __name__ == "__main__":
    ...
    experiment = build_mazehard_hrm_v2_training_experiment(settings.experiment)
