"""Training entrypoint for HRM v1 (ACT-supervised) experiments."""
...
from ehc_sn.experiments.mazehard.hrm_v1.training import (
...
DEFAULT_CONFIG = "config/training/hrm-v1-mazehard-vram8gib.toml"
...
class CliSettings(BaseSettings):
    """CLI entry point for HRM v1 MazeHard training.
    ...
    experiment: MazeHardHRMV1TrainingExperimentConfig = Field(
        ...,
...
if __name__ == "__main__":
    ...
    experiment = build_mazehard_hrm_v1_training_experiment(settings.experiment)
