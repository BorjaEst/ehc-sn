"""Training entrypoint for TEM v1 experiments."""
...
from ehc_sn.experiments.arena.tem_v1 import build_experiment as build_tem_v1
...
from ehc_sn.lightning.modules.variational_replay import (
    VariationalReplayConfig as TEMV1ModelConfig,
)
