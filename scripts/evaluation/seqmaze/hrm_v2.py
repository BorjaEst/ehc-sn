#!/usr/bin/env python3
"""Evaluate HRM-V2 on seqmaze — convenience alias around ``run_eval.py run``."""
...
def run(
    ...
    """Execute a checkpoint against the seqmaze HRM-V2 experiment."""
    try:
        loaded = load_evaluation_experiment(
            config,
            expected_experiment_id="hrm-v2-seqmaze",
        )
