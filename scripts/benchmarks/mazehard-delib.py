"""Thin CLI wrapper for the MazeHard-Delib benchmark track."""
...
_DEFAULT_TRACK_ID = "mazehard-delib"
_DEFAULT_CONFIG_PATH = "config/benchmarks/mazehard-delib.toml"
...
class RunArguments(BaseSettings, cli_parse_args=True, cli_kebab_case=True):
    """Script-local CLI/config settings for the MazeHard-Delib wrapper."""
