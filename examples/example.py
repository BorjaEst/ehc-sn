...
from ehc_sn.data.simple_example import create_dataset, make_figure
...
class Experiment(BaseModel):
    ...
    datamodule: DataModuleParams = Field(default_factory=DataModuleParams, description="DataModule parameters")
    ...
    def run(self):
        ...
        data_gen = lambda n: TensorDataset(*create_dataset(n, self.input_units, self.output_units))
